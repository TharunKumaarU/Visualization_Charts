...
file_path = 'your_dataset.xlsx'  # Replace with your Excel file path
df = pd.read_excel(file_path)

# 1. Bar Chart: Population of Each Country
...
# 2. Pie Chart: Proportion of GDP by Country
...
# 3. Scatter Plot: Life Expectancy vs. CO2 Emissions
...
# 5. Box Plot: Distribution of Internet Users Across Countries
plt.figure(figsize=(10, 6))
...
# 6. Line Chart: GDP of Each Country
plt.figure(figsize=(10, 6))
...
# 7. Histogram: Distribution of Life Expectancy
plt.figure(figsize=(10, 6))
...
# 8. Area Chart: Cumulative GDP of Each Country
...
# 9. Bubble Chart: Population vs. GDP with CO2 Emissions as Bubble Size
plt.figure(figsize=(10, 6))
...
# 10. Tree Map: Forest Area as Proportion of Total Area
# Treemaps aren't directly supported in matplotlib or seaborn, so you'd use a specialized library like squarify or plotly.
import squarify
